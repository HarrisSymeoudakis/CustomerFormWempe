fetch('https://customerinfowempeserver.onrender.com/swagger/CustomerUserFields')
	...
	.then(data => {
		...
		document.getElementById('usrfield5').value = usrFields[5].value.number.toString() || "";
		document.getElementById('usrfield6').value = usrFields[6].value.number.toString() || "";
		document.getElementById('usrfield7').value = usrFields[7].value.number.toString() || "";
		document.getElementById('usrfield8').value = usrFields[8].value.number.toString() || "";
